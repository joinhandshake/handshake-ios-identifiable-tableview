...
class ConversationViewController: TableViewController {
    ...
    override func viewDidLoad() {
        ...
        let plainCellModels: [IdentifiableCellModel] = [
        ...
        let messageCellModels: [IdentifiableCellModel] = [
        ...
        let plainSection = TableViewSection(cellModels: plainCellModels)
        let messagesSection = TableViewSection(cellModels: messageCellModels)
        
        sections = [plainSection, messagesSection]
    }
}
